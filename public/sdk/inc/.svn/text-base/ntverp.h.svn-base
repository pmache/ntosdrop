...
#define VER_PRODUCTBUILD            /* NT */   HIROSHIMA_BUILD_NUMBER

#define VER_PRODUCTBUILD_QFE        HIROSHIMA_REVISION
...
#define VER_PRODUCTMAJORVERSION     HIROSHIMA_MAJOR
#define VER_PRODUCTMINORVERSION     HIROSHIMA_MINOR   
